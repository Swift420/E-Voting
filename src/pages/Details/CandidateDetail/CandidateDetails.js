...
const CandidateDetails = () => {
    const { id} = useParams();
   var x = Number(id)
    const candidate =  candidatesData.find(data=> 
        { return data.id === x
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">{candidate.faculty}</p>
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{candidate?.fullname}</h2>
                    ...
                    <div className=" flex flex-row justify-between  mt-5">
                        ...
                        <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-700 hover:underline hover:text-gray-800 duration-100 cursor-pointer">{`${candidate.votes} Votes`}</p>
                    </div>

                    <p className=" font-normal text-base leading-6 text-gray-600 mt-7">{candidate.Bio}</p>
                    <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">{candidate.candidancy}</p>

                    

                    <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">Vote</button>
                </div>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 flex justify-center items-center">
                        <img src={candidate.pictures[0]} alt="Wooden Chair Previw" />
                    </div>
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div className=" flex justify-center items-center py-4">
                            <img src={candidate.pictures[1]} alt="Wooden chair - preview 1" />
                        </div>
                        <div className="flex justify-center items-center py-4">
                            <img src={candidate.pictures[2]}alt="Wooden chair - preview 2" />
                        </div>
                        <div className="flex justify-center items-center py-4">
                            <img src={candidate.pictures[3]} alt="Wooden chair- preview 3" />
                        </div>
                    </div>
                </div>
            </div>
